    ...
    <main className='relative h-full w-full transition-width flex flex-col overflow-hidden items-stretch flex-1'>
      <div className='flex-1 overflow-hidden'>
        <div className='h-full dark:bg-gray-800'>
          <div className='flex flex-col items-center text-sm h-full dark:bg-blue-700'>
            {responseMessage === '' ? (
              loading ? (
      ...
      <div className='absolute bottom-0 left-0 w-full border-t md:border-t-0 dark:border-white/20 md:border-transparent md:dark:border-transparent md:bg-vert-light-gradient bg-white dark:bg-gray-800 md:!bg-transparent dark:md:bg-vert-dark-gradient'>
        {loading ? (
          ...
          >
            <div className='relative flex h-full flex-1 md:flex-col'>
              ...
              <div className='flex flex-col w-full py-2 flex-grow md:py-3 md:pl-4 relative border border-black/10 bg-white dark:border-gray-900/50 dark:gray-700 dark:bg-gray-100 rounded-md shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:shadow-[0_0_15px_rgba(0,0,0,0.10)]'>
                <input
        ...
        <div className='px-3 pt-2 pb-3 text-center text-xs text-black/50 dark:text-white/50 md:px-4 md:pt-3 md:pb-6'>
          <a
            href='https://ediliziacrobatica.com/'
            target='_blank'
            rel='noreferrer'
            className='underline'
          >
            EDAC GPT 1.0 Version 
          </a>
          ...
          <p>Made with ♥ by
          <a
            href='https://www.marcotorquato.com/'
            target='_blank'
            rel='noreferrer'
            className='underline'
          >
